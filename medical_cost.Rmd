...
## Factors that affect charge of insurance {.tabset}
...
YES! Smoker have significantly higher insurance cost than non smoker. This confirm that insurance company assign different price for smokers and non-smokers.
...
There is no collinearity between any of the variables. Therefore, no need to adjust variable for model building
...
Although the t-test for sex shows that the mean charge of insurance is different for male and female, the model building result shows otherwise. Therefore, we remove the sex variable.
...
The four graph above shows homoscedasticity of residual. The model fits nicely!
