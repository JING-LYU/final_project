...
3. How does personal factors(age, having children, smoking, bmi) affect insurance preferences and premiums?


During exploration stage, we found that smokers tend to be poorer compare to non-smokers. Being in poor personal financial status may prevent people from spending on insurance. 

Higher proportion of smokers also rated themselves as not in excellent health status compare to non-smokers. Being in unsatisfactory health status should motivate people to get insurance. 

We also found that people tend to get insurance as age increase. 

heavy smoker have slightly higher bmi compare to other people

We did not find any correlation between bmi and insurance from the survey.
