...
* `agegroup`: Age groups (1 = 18-24 yrs, 2 = 25-44 yrs, 3 = 45-64 yrs, 4 = 65+ yrs)
...
1. Is insured rate differed by smoking status?

Yes. The uninsured rate for current smokers is 44.4% higher than people who currently do not smoke.

2. What type of insurance do people tend to get?

For person younger than 65 years old, people tend to get insurance as age increase. Specifically, for those age in the range of 25-64 years old, most of them get employer insurance since they are in working age.

For person older than 65 years old, most of them get Medicare since Medicare is only provided for people above 65 years old.

3. How does smoking and other personal factors(age, having children, BMI) affect insurance purchasing and premiums?

During exploration stage, we found that smoker have lower insured rate than non-smokers. Moreover, smokers tend to have more unsatisfactory financial status compare to non-smokers. Being in poor financial status may prevent people from purchasing insurance. We also found that as people age increase, the proportion of people holding insurance increase. In addition, people who have at least one child have higher insured rate compare to people who do not have children. We could not found association between BMI and insurance from this survey.
