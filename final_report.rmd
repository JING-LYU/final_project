...
During exploration stage, we found that smokers tend to be poorer compare to non-smokers. Higher proportion of them also rated themselves as not in excellent health status compare to non-smokers. 
