...
For **Community Health Survey Public Use Data**, we select year 2014-2016 and variables relating to smoking and insurance. 
...
dataset_basic = chs_14_16 %>% 
  dplyr::select(agegroup,insure,smoker,everyday,numberperdaya,cost20cigarettes,generalhealth,imputed_povertygroup,bmi,child,sex) %>% 
