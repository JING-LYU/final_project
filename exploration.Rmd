...
There's no significant difference between current smokers with different smoking intensity.
...
We found that, regardless of the smoking status, most people tend to get employer insurance. For former smokers, a larger proportion of them get the medicare insurance compare to people who never smoke or currently smoke.

For current smokers, the uninsured rate is `r pull(analyse_smoke_insurancetype,freq)[14]`.

For former smokers and people who never smokes, the uninsured rate is `r (379+1858)/(18368+6090)`
...
*Test result:*
```{r}
#| my-chunk6, echo = FALSE, fig.width = 10,fig.height = 8
