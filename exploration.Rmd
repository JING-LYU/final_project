...
Among 2941 participants in the dataset, 2582(88%) of them are insurance holders, while 359 (12%) of them don't have insurance cover. Most of participants have employer-sponsored health insurance (38%), other types include Medicaid/Family Health+ (24%), Medicare(20%), Uninsured(9%), Self-purchase(6%), COBRA/Other(2%) and Milit/CHAMPUS/Tricare (1%). Detailed introduction on each insurance type is summarized in the below table.
...
### 2. Knowledge regarding **smoking** in our dataset {.tabset}
